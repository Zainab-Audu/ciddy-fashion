...
import Promotions from "../Pages/Cataloguepage/Promotions";
        ...
        <section className="flex mt-10 justify-between flex-col lg:flex-row md:flex-row">
          <div className="w-[100%] lg:w-[50%] md:w-[50%]">
            <div
              ...
              className="bg-cover bg-center h-[30vh] p-6 flex justify-start items-start flex-col rounded-lg mb-4 bg-gray-700 bg-blend-overlay text-[#FFF200]"
            >
              <p className="lg:text-[2rem] md:text-[2rem] text-[1.5rem] lg:w-[50%] uppercase">
            ...
            <div
              ...
              className="bg-cover bg-center h-[30vh] p-6 flex justify-start items-start flex-col rounded-lg bg-gray-700 bg-blend-overlay text-[#FFF200] mb-4"
            >
              <p className="lg:text-[2rem] md:text-[2rem] text-[1.5rem] lg:w-[60%] md:w-[60%] uppercase">
          ...
          <div
            ...
            className="bg-cover bg-center h-[62vh] p-6 flex justify-start items-start flex-col rounded-lg lg:w-[48%] md:w-[48%] bg-gray-700 bg-blend-overlay text-[#FFF200]"
          >
            <p className="lg:text-[2rem] md:text-[2rem] text-[1.5rem] lg:w-[80%] md:w-[80%] w-[90%] uppercase mt-auto">
