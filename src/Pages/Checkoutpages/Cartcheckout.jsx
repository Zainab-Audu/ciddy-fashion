...
const Cartcheckout = () => {
  return (
    <div>
      <Navbar />
      <div className=" w-full bg-gradient-to-t from-[#faf8fa] via-[#e4e2e7] to-[#c9c7cd] text-black flex flex-col lg:flex-row justify-center items-center lg:px-[100px] pt-5    ">
