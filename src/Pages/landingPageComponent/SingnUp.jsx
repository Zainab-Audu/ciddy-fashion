...
const SingnUp = () => {
  return (
    <div>
      <div
        id="signup"
        className=" w-full bg-gradient-to-t from-[#faf8fa] via-white to-[#c9c7cd] text-black flex flex-col lg:flex-row justify-center items-center lg:px-[100px] pt-28 pb-32  h-screen "
      >
